        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <!-- Header -->
                    <tr>
                        <td style="background-color:{{ $headerColor }};padding:30px 40px;">
                            <h1 style="margin:0;color:#ffffff;font-size:20px;font-weight:700;">{{ $headerIcon }}
                                {{ $headerTitle }}</h1>
                            <p style="margin:6px 0 0;color:{{ $headerSubColor }};font-size:13px;">{{ $headerSubtitle }}
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:32px 40px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="border-top:1px solid #e5e7eb;background-color:#ffffff;">
                                    <td
                                        ...
                                        Requested By</td>
                                    <td style="padding:12px 16px;font-size:13px;color:#111827;">
                                        {{ $requestor->user_fname }} {{ $requestor->user_lname }}</td>
                                </tr>
                                @if ($note)
                                    <tr style="border-top:1px solid #e5e7eb;">
                                        <td
                                            style="padding:12px 16px;font-size:13px;color:#6b7280;border-right:1px solid #e5e7eb;">
                                            Note</td>
                                        <td style="padding:12px 16px;font-size:13px;color:#111827;">{{ $note }}
                                        </td>
                                    </tr>
                                @endif
                            </table>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="border-radius:6px;background-color:{{ $headerColor }};">
                                        <a href="{{ $ctaUrl }}"

                    ...
                    <tr>
                        <td style="background-color:#16a34a;padding:30px 40px;">
                            @if ($recipientType === 'manager')
                                <h1 style="margin:0;color:#ffffff;font-size:20px;font-weight:700;">✅ Approval Confirmed
                                </h1>
                                <p style="margin:6px 0 0;color:#bbf7d0;font-size:13px;">You have successfully approved
                                    the completion request for this work order.</p>
                            @else
                                <h1 style="margin:0;color:#ffffff;font-size:20px;font-weight:700;">🎉 Work Order
                                    Completed!</h1>
                                <p style="margin:6px 0 0;color:#bbf7d0;font-size:13px;">The completion request for this
                                    work order has been approved.</p>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:32px 40px;">
                            <p style="margin:0 0 24px;font-size:14px;color:#6b7280;line-height:1.6;">
                                @if ($recipientType === 'manager')
                                    You have approved the completion request for the following work order. The assigned
                                    technicians have been notified.
                                @else
                                    The completion request for the following work order has been approved by
                                    <strong style="color:#111827;">{{ $approver->user_fname }}
                                        {{ $approver->user_lname }}</strong>.
                                    Great work!
                                @endif
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="border-top:1px solid #e5e7eb;background-color:#ffffff;">
                                    <td
                                        ...
                                        Approved By</td>
                                    <td style="padding:12px 16px;font-size:13px;color:#111827;">
                                        {{ $approver->user_fname }} {{ $approver->user_lname }}</td>
                                </tr>
                                @if ($note)
                                    <tr style="border-top:1px solid #e5e7eb;">
                                        <td colspan="2" style="padding:12px 16px;">
                                            <p
                                                ...
                                                Note</p>
                                            <p
                                                style="margin:0;font-size:13px;color:#111827;background-color:#f0fdf4;border:1px solid #bbf7d0;border-radius:4px;padding:10px 12px;line-height:1.6;">
                                                {{ $note }}</p>
                                        </td>
                                    </tr>
                                @endif

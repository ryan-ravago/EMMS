        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td
                            style="background-color:{{ $recipientType === 'manager' ? '#16a34a' : '#dc2626' }};padding:30px 40px;">
                            @if ($recipientType === 'manager')
                                <h1 style="margin:0;color:#ffffff;font-size:20px;font-weight:700;">✅ Rejection Confirmed
                                </h1>
                                <p style="margin:6px 0 0;color:#bbf7d0;font-size:13px;">You have successfully rejected
                                    the completion request for this work order.</p>
                            @else
                                <h1 style="margin:0;color:#ffffff;font-size:20px;font-weight:700;">❌ Completion Request
                                    Rejected</h1>
                                <p style="margin:6px 0 0;color:#fecaca;font-size:13px;">The completion request for this
                                    work order has been rejected.</p>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:32px 40px;">
                            <p style="margin:0 0 24px;font-size:14px;color:#6b7280;line-height:1.6;">
                                @if ($recipientType === 'manager')
                                    You have rejected the completion request for the following work order. The assigned
                                    technicians have been notified.
                                @else
                                    The completion request for the following work order has been rejected by
                                    <strong style="color:#111827;">{{ $rejector->user_fname }}
                                        {{ $rejector->user_lname }}</strong>.
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="border-top:1px solid #e5e7eb;background-color:#ffffff;">
                                    <td
                                        ...
                                        Rejected By</td>
                                    <td style="padding:12px 16px;font-size:13px;color:#111827;">
                                        {{ $rejector->user_fname }} {{ $rejector->user_lname }}</td>
                                </tr>
                                <tr style="border-top:1px solid #e5e7eb;">
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td
                                        style="border-radius:6px;background-color:{{ $recipientType === 'manager' ? '#16a34a' : '#dc2626' }};">

                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="background-color:#16a34a;padding:30px 40px;">
                            <h1 style="margin:0;color:#ffffff;font-size:20px;font-weight:700;">✅ Finding Disregarded
                            </h1>
                            <p style="margin:6px 0 0;color:#bbf7d0;font-size:13px;">You have successfully disregarded
                                this inspection finding.</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:32px 40px;">
                            <p style="margin:0 0 24px;font-size:14px;color:#6b7280;line-height:1.6;">
                                The following inspection finding has been marked as disregarded by you. No further
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="border-top:1px solid #e5e7eb;">
                                    <td
                                        ...
                                        Failed Item</td>
                                    <td style="padding:12px 16px;font-size:13px;color:#111827;">
                                        {{ $inspectionItem->insi_cli_name_for_record }}</td>
                                </tr>
                                <tr style="border-top:1px solid #e5e7eb;background-color:#ffffff;">
                                    <td
                                        style="padding:12px 16px;font-size:13px;color:#6b7280;border-right:1px solid #e5e7eb;">
                                        Disregarded By</td>
                                    <td style="padding:12px 16px;font-size:13px;color:#111827;">
                                        {{ $manager->user_fname }} {{ $manager->user_lname }}</td>
                                </tr>
                                <tr style="border-top:1px solid #e5e7eb;">
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="border-radius:6px;background-color:#16a34a;">
                                        <a href="{{ config('app.url') }}/inspection-items/{{ $inspectionItem->insi_id }}"
